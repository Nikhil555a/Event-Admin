  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-4 flex items-center">
        <User className="w-5 h-5 mr-2" /> Organizer: {event.createdBy || "Unknown"}
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <p className="text-gray-700">
            <span className="font-medium">Event Date:</span> {formatDate(event.eventDate)}
          </p>
        </div>
        <div className="flex items-center gap-3">
          <MapPin className="text-gray-500 w-5 h-5" />
          <p className="text-gray-700">
            <span className="font-medium">Venue City:</span> {event.venueCity || "N/A"}
          </p>
        </div>
      </div>
          ...
          <table className="min-w-full table-auto border border-gray-200">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-2 border">On Sale</th>
              </tr>
            </thead>
            <tbody>
              {tickets.map((t, index) => (
